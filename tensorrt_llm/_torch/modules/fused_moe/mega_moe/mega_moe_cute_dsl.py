...
class MegaMoECuteDsl(MoE):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # AutoTuner tactic-sweep opt-in (default OFF): warmup would otherwise
        # pay the MERGE lockstep sweep (~36 tactics x multi-minute JIT + a
        # multi-GiB symmetric scratch). Must be rank-identical (it gates
        # collective tuning behavior).
